...
public class AppController {
    ...
    public BaseResponse<String> deployApp(@RequestBody AppDeployRequest appDeployRequest, HttpServletRequest request) {
        ThrowUtils.throwIf(appDeployRequest == null, ErrorCode.PARAMS_ERROR, "参数为空");
     ...
     * @return 应用列表
     */
    @GetMapping("/admin/list/page/vo")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Page<AppVO>> adminListAppByPage(AppAdminQueryRequest appAdminQueryRequest) {
        ...
        QueryWrapper adminQueryWrapper = appService.getAdminQueryWrapper(appAdminQueryRequest);
        // 分页查询
        Page<App> page = appService.page(
                Page.of(pageNum, pageSize),
                adminQueryWrapper
